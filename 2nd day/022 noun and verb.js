...
for (n=0;n<100;n++){
    for (v=0;v<100;v++){
        ...
        while (true){
            ...
            let b = arr[asd+2];
            let c = arr[asd+3];
            if (arr[asd] == 1) arr[c] = arr[a] + arr[b];
            else if (arr[asd] == 2) arr[c] = arr[a] * arr[b];
            else break;
            asd += 4;
        }
        if (arr[0] === 19690720) console.log(`${arr[1]}${arr[2]}`);
    }
}